...
public class Environment extends ShadedColoredModel {
    ...
    public Environment(int id, ShadedColoredModel model){

        ObjectMaker maker=new ObjectMaker();
        maker.identity();
        maker.color(0.5f,0.5f,0.5f);

        //This file contains several spaceship models made by the students of this class.
        //Each model was assigned an ID number.
        //You can make one of these models in your Renderer class using:
        //Spaceship my_spaceship=new Spaceship(id);
...
//revu54r1rahb0vh9
        ...
        if(model==null)maker2.flush(this);
        else maker2.flush(model);
    }

    public static int getNumOfModels(){return 35;}
